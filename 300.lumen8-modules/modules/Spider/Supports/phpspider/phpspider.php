...
namespace Modules\Spider\Supports\phpspider;

require_once __DIR__ . '/constants.php';

use Exception;
use Modules\Spider\Supports\phpspider\db;
use Modules\Spider\Supports\phpspider\log;
use Modules\Spider\Supports\phpspider\queue;
use Modules\Spider\Supports\phpspider\requests;
use Modules\Spider\Supports\phpspider\selector;
use Modules\Spider\Supports\phpspider\util;
