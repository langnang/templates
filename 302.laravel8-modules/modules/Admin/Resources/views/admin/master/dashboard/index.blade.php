            ...
            <div class="card-body">
              <div class="tab-content p-0">
                ...
                <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                  ...
                  <canvas id="revenue-chart-canvas" height="300" style="height: 300px; display: block; width: 525px;"
                    width="525" class="chartjs-render-monitor"></canvas>
                </div>
            ...
            <div class="card-footer bg-transparent">
              <div class="row">
                <div class="col-4 text-center">
                  <div id="sparkline-1"><canvas width="80" style="width: 80px; height: 50px;"
                      height="50"></canvas></div>
                  <div class="text-white">Visitors</div>
                </div>

                <div class="col-4 text-center">
                  <div id="sparkline-2"><canvas width="80" style="width: 80px; height: 50px;"
                      height="50"></canvas></div>
                  <div class="text-white">Online</div>
                </div>

                <div class="col-4 text-center">
                  <div id="sparkline-3"><canvas width="80" style="width: 80px; height: 50px;"
                      height="50"></canvas></div>
          ...
          <div class="card bg-gradient-info">
            ...
            <div class="card-body">
              ...
              <canvas class="chart chartjs-render-monitor" id="line-chart"
                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 359px;"
                width="359" height="250"></canvas>
            </div>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th class="picker-switch" data-action="pickerSwitch" colspan="5"
                                  title="Select Month">June 2024</th>
